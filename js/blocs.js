...
$(document).ready(function() {
    ...
    }), extraNavFuncs(), setUpSpecialNavs(), setUpDropdownSubs(), setUpVisibilityToggle(), -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") && $("#page-loading-blocs-notifaction").remove()
